/**
 * script-culture.js
 * Charge les articles de la catégorie "Culture" depuis Supabase
 */
      ...
      card.innerHTML = `
        <a href="article-details.html?title=${encodeURIComponent(article.title)}" class="block">
          ...
          <div class="p-4">
            ...
            <p class="text-[10px] text-gray-400 mt-2 uppercase">${article.categorie || 'Culture'} • ${published}</p>
